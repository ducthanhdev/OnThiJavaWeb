...
public class XLTimKiem extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Product> listPD = new ArrayList<>();
            try {
                ConnectDB con = new ConnectDB();
                ResultSet rs = con.getData("select * from product where ID = "+IDQuery);
                while (rs.next()) {
                    int ID = rs.getInt("ID");
                ...
                request.setAttribute("ID", IDQuery);
                request.setAttribute("list", listPD);
